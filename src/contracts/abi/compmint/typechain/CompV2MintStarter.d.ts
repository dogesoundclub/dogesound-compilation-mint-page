...
interface CompV2MintStarterInterface extends ethers.utils.Interface {
  functions: {
...
export class CompV2MintStarter extends Contract {
  ...
  interface: CompV2MintStarterInterface;

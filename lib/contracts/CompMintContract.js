...
class CompMintContract extends PolygonContract_1.default {
    constructor() {
        super("0x706Fc0944cBF26a4322f3FB89228214Ea7Cc965C", CompMint_json_1.default.abi, []);
    }
    async mint(id) {
        ...
        if (contract !== undefined && owner !== undefined) {
            ...
            if ((await PolygonMixContract_1.default.allowance(owner, this.address)).lt(price)) {
